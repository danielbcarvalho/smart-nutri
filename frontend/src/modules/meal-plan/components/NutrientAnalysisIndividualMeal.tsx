...
interface NutrientAnalysisIndividualMealProps {
  protein: number;
  fat: number;
...
export const NutrientAnalysisIndividualMeal: React.FC<
  NutrientAnalysisIndividualMealProps
> = ({ protein, fat, carbohydrates, calories, totalWeight }) => {
...
export default NutrientAnalysisIndividualMeal;
